...
import 'detailtree_model.dart';
export 'detailtree_model.dart';

class DetailtreeWidget extends StatefulWidget {
  const DetailtreeWidget({
    super.key,
    String? price,
    String? vilage,
    String? locaname,
  ...
  final String height;
  final String asl;
  final String surveidate;
  final String photosby;
  final String surveyedby;
  final String adopttedby;
...
class _DetailtreeWidgetState extends State<DetailtreeWidget> {
  late DetailtreeModel _model;
                ...
                child: Column(
                  ...
                  children: [
                    FutureBuilder<ApiCallResponse>(
                      future: RestAPiPohonAsuhGroup.imagepohonCall.call(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final carouselImagepohonResponse = snapshot.data!;

                        return Builder(
                          builder: (context) {
                            final response = (carouselImagepohonResponse
                                            .jsonBody
                                            .toList()
                                            .map<ResponSLiderPohonStruct?>(
                                                ResponSLiderPohonStruct
                                                    .maybeFromMap)
                                            .toList()
                                        as Iterable<ResponSLiderPohonStruct?>)
                                    .withoutNulls
                                    .toList() ??
                                [];
                            ...
                            return Container(
                              ...
                              child: CarouselSlider.builder(
                                ...
                                itemBuilder: (context, responseIndex, _) {
              ...
              Builder(
                builder: (context) => Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      _model.apiResultmtf =
                          await RestAPiPohonAsuhGroup.tobasketCall.call(
                        idPohon: widget.idpohon,
                      ...
                      if ((_model.apiResultmtf?.succeeded ?? true)) {
                        if (RespontambahkeranjangStruct.maybeFromMap(
                                    (_model.apiResultmtf?.jsonBody ?? ''))
                                ?.code ==
                            '200') {
                          await showDialog(
                            context: context,
                              ...
                              return Dialog(
                                ...
                                child: GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    child: InformationWidget(
                                      messageParameter:
                                          'The tree is already in the basket, please look for another tree',
                                    ),
                                  ),
                                ),
                              );
