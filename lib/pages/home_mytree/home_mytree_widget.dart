          ...
          child: Stack(
            children: [
              Container(
                ...
                child: Padding(
                  padding:
                      EdgeInsetsDirectional.fromSTEB(20.0, 80.0, 20.0, 80.0),
                                          ...
                                          RichText(
                                            ...
                                            text: TextSpan(
                                              children: [
                                                ...
                                                TextSpan(
                                                  text: () {
                                                    if (responseMytreeItem
                                                            .proses ==
                                                        3) {
                                                      return 'Taging Complate';
                                                    } else if (responseMytreeItem
                                                            .proses ==
                                                        2) {
                                                      return 'Proses Taging';
                                                    } else {
                                                      return 'On Proses';
                                                    }
                                                  }(),
