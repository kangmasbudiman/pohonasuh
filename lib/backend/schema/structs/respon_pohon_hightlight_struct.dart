...
class ResponPohonHightlightStruct extends BaseStruct {
  ...
  // "gpscode" field.
  String? _gpscode;
  String get gpscode => _gpscode ?? '';
  set gpscode(String? val) => _gpscode = val;

  bool hasGpscode() => _gpscode != null;
  ...
  static ResponPohonHightlightStruct fromMap(Map<String, dynamic> data) =>
      ResponPohonHightlightStruct(
        id: castToType<int>(data['id']),
        gpscode: data['gpscode'] as String?,
        ...
        asl: data['asl'] as String?,
        highlight: castToType<int>(data['highlight']),
        tglExp: data['tgl_exp'] as String?,
        fotoPohon: data['foto_pohon'] as String?,
      );

  static ResponPohonHightlightStruct? maybeFromMap(dynamic data) => data is Map
      ? ResponPohonHightlightStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static ResponPohonHightlightStruct fromSerializableMap(
  ...
  @override
  String toString() => 'ResponPohonHightlightStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is ResponPohonHightlightStruct &&
        id == other.id &&
...
ResponPohonHightlightStruct createResponPohonHightlightStruct({
  int? id,
  String? gpscode,
  String? latitude,
  String? longitude,
