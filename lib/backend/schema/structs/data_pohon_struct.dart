...
class DataPohonStruct extends BaseStruct {
  DataPohonStruct({
    int? id,
    String? gpscode,
    String? latitude,
  ...
  static DataPohonStruct fromMap(Map<String, dynamic> data) => DataPohonStruct(
  ...
  static DataPohonStruct? maybeFromMap(dynamic data) => data is Map
      ? DataPohonStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static DataPohonStruct fromSerializableMap(Map<String, dynamic> data) =>
      DataPohonStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'DataPohonStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is DataPohonStruct &&
        id == other.id &&
...
DataPohonStruct createDataPohonStruct({
  int? id,
  String? gpscode,
  String? latitude,
  String? longitude,
