...
class ResponPohonBypengurusStruct extends BaseStruct {
  ...
  // "idconfirmasi" field.
  int? _idconfirmasi;
  int get idconfirmasi => _idconfirmasi ?? 0;
  set idconfirmasi(int? val) => _idconfirmasi = val;

  void incrementIdconfirmasi(int amount) =>
      idconfirmasi = idconfirmasi + amount;

  bool hasIdconfirmasi() => _idconfirmasi != null;
  ...
  static ResponPohonBypengurusStruct fromMap(Map<String, dynamic> data) =>
      ResponPohonBypengurusStruct(
        ...
        idconfirmasi: castToType<int>(data['idconfirmasi']),
  ...
  static ResponPohonBypengurusStruct? maybeFromMap(dynamic data) => data is Map
      ? ResponPohonBypengurusStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static ResponPohonBypengurusStruct fromSerializableMap(
  ...
  @override
  String toString() => 'ResponPohonBypengurusStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is ResponPohonBypengurusStruct &&
        id == other.id &&
        ...
        tglExp == other.tglExp &&
        foto == other.foto &&
        idconfirmasi == other.idconfirmasi &&
...
ResponPohonBypengurusStruct createResponPohonBypengurusStruct({
  int? id,
  String? idpohon,
  int? pengasuh,
  String? nama,
