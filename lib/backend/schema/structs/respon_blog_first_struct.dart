...
class ResponBlogFirstStruct extends BaseStruct {
  ResponBlogFirstStruct({
    int? id,
    String? name,
    String? deskripsi,
    int? viewer,
  ...
  static ResponBlogFirstStruct fromMap(Map<String, dynamic> data) =>
      ResponBlogFirstStruct(
  ...
  static ResponBlogFirstStruct? maybeFromMap(dynamic data) => data is Map
      ? ResponBlogFirstStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static ResponBlogFirstStruct fromSerializableMap(Map<String, dynamic> data) =>
      ResponBlogFirstStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'ResponBlogFirstStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is ResponBlogFirstStruct &&
        id == other.id &&
        name == other.name &&
...
ResponBlogFirstStruct createResponBlogFirstStruct({
  int? id,
  String? name,
  String? deskripsi,
  int? viewer,
