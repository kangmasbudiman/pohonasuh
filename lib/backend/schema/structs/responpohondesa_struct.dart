...
class ResponpohondesaStruct extends BaseStruct {
  ResponpohondesaStruct({
    int? id,
    String? gpscode,
    String? latitude,
    String? longitude,
  ...
  static ResponpohondesaStruct fromMap(Map<String, dynamic> data) =>
      ResponpohondesaStruct(
  ...
  static ResponpohondesaStruct? maybeFromMap(dynamic data) => data is Map
      ? ResponpohondesaStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static ResponpohondesaStruct fromSerializableMap(Map<String, dynamic> data) =>
      ResponpohondesaStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'ResponpohondesaStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is ResponpohondesaStruct &&
        id == other.id &&
...
ResponpohondesaStruct createResponpohondesaStruct({
  int? id,
  String? gpscode,
  String? latitude,
  String? longitude,
