...
class ResponBlogByFilterStruct extends BaseStruct {
  ...
  static ResponBlogByFilterStruct fromMap(Map<String, dynamic> data) =>
      ResponBlogByFilterStruct(
  ...
  static ResponBlogByFilterStruct? maybeFromMap(dynamic data) => data is Map
      ? ResponBlogByFilterStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static ResponBlogByFilterStruct fromSerializableMap(
  ...
  @override
  String toString() => 'ResponBlogByFilterStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is ResponBlogByFilterStruct &&
        id == other.id &&
        name == other.name &&
...
ResponBlogByFilterStruct createResponBlogByFilterStruct({
  int? id,
  String? name,
  String? deskripsi,
  int? viewer,
