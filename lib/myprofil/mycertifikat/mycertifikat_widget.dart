...
export 'mycertifikat_model.dart';
...
class _MycertifikatWidgetState extends State<MycertifikatWidget> {
  late MycertifikatModel _model;
          ...
          child: Padding(
            ...
            child: FutureBuilder<ApiCallResponse>(
              ...
              builder: (context, snapshot) {
                ...
                final columnMycertificateResponse = snapshot.data!;

                return Builder(
                  builder: (context) {
                    final response = (columnMycertificateResponse.jsonBody
                                    .toList()
                                    .map<ResponseMycertifikatStruct?>(
                                        ResponseMycertifikatStruct.maybeFromMap)
                                    .toList()
                                as Iterable<ResponseMycertifikatStruct?>)
                            .withoutNulls
                            .toList() ??
                        [];
