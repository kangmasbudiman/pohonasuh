...
class DetailPesanWidget extends StatefulWidget {
  ...
  static String routeName = 'detailPesan';
  static String routePath = '/detailPesan';

  @override
  State<DetailPesanWidget> createState() => _DetailPesanWidgetState();
}
