...
class ContentDrawerWidget extends StatefulWidget {
  const ContentDrawerWidget({super.key});

  @override
  State<ContentDrawerWidget> createState() => _ContentDrawerWidgetState();
}

class _ContentDrawerWidgetState extends State<ContentDrawerWidget> {
  late ContentDrawerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ContentDrawerModel());
  }
        ...
        children: [
          FutureBuilder<ApiCallResponse>(
            ...
            builder: (context, snapshot) {
              ...
              final columnGetProfilResponse = snapshot.data!;
                              ...
                              children: [
                                Text(
                                  valueOrDefault<String>(
                                    GetProfilTYpeStruct.maybeFromMap(
                                            columnGetProfilResponse.jsonBody)
                                        ?.name,
                                    'name',
                                  ),
                                ...
                                Text(
                                  () {
                                    if (GetProfilTYpeStruct.maybeFromMap(
                                                columnGetProfilResponse
                                                    .jsonBody)
                                            ?.admin ==
                                        0) {
                                      return 'User';
                                    } else if (GetProfilTYpeStruct.maybeFromMap(
                                                columnGetProfilResponse
                                                    .jsonBody)
                                            ?.admin ==
                                        1) {
          ...
          Padding(
            ...
            child: Builder(
              builder: (context) {
                ...
                } else if (currentUserData?.admin == 2) {
                  return Column(
                    mainAxisSize: MainAxisSize.max,
                    children: [
                      Padding(
